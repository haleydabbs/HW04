...
# 1 "cactus.h" 1
# 21 "cactus.h"
extern const unsigned short cactusBitmap[1440];


extern const unsigned short cactusPal[256];
# 5 "game.c" 2
# 1 "cactus2.h" 1
# 21 "cactus2.h"
extern const unsigned short cactus2Bitmap[1344];


extern const unsigned short cactus2Pal[256];
# 6 "game.c" 2
...
void initGame() {
    ...
    u16 colors[7] = {0, ((31) | (0)<<5 | (31)<<10), ((0) | (31)<<5 | (31)<<10), ((0) | (31)<<5 | (0)<<10), ((31) | (0)<<5 | (0)<<10), ((31) | (31)<<5 | (31)<<10), ((15) | (15)<<5 | (15)<<10)};


    DMANow(3, cactusPal, ((unsigned short *)0x5000000), (7 | (0 << 21) | (0 << 23)));
...
void initCactus() {
    ...
    for (int i = 0; i < 2; i ++) {
        ...
        cacti[i].width = 48;
        cacti[i].active = i ^ 1;
        cacti[i].row = 120 - cacti[i].height;
        cacti[i].col = (170 + cacti[i].width) >> 2;
    }
...
void drawPlantBox() {
    drawRect4(0, 120, 240, 2, GRAYID);
    drawRect4(170, 0, 2, 120 + 2, GRAYID);
}
